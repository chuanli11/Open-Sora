...
def log_sample(model, text_encoder, vae, scheduler, coordinator, cfg, epoch, exp_dir, global_step, dtype, device):
    ...
    prompts = [
        ...
        "An archaeological site in the Mayan jungle. A Mayan pyramid rises above the green landscape. The camera slowly rises from the lush forest floor to reveal the majestic pyramid emerging from the dense greenery.",
        ...
        "A small llama approaches a larger llama, presumably the mother. Both animals are surrounded by yellow flowers and are standing on a grassy hill. The sky is blue, with only a few white clouds casting shadows on the landscape behind the llamas.",
